...
const DeliveryLogin = () => {
    ...
    // Once the user is loaded in context after login, navigate to /delivery
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Set flag — navigation happens in useEffect when user context is ready
            ...
            <div className="flex-1 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Sign in to access your delivery dashboard, or{' '}
                        <Link to="/deliver/signup" className="font-medium text-blue-700 hover:text-blue-600">
